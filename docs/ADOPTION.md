...
- installs a self-contained AG2C runtime without requiring Python, administrator rights, or Edge WebView2; the tray is a native window and the package ships MinGit next to the app;
