...
- [GUI-WEBVIEW2.md](GUI-WEBVIEW2.md) — 窗口皮肤已换到 WebView2，保留首页/树/检查器/运维布局。
- [GUI-RETIREMENT.md](GUI-RETIREMENT.md) — 次要：托盘窗口维护成本；继任壳见 GUI-WEBVIEW2.md（主线见 GOVERNANCE-PACK.md）。
