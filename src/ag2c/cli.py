...
def build_parser() -> argparse.ArgumentParser:
    ...
    checker_cmd = govern_commands.add_parser("checker", help="create or adjust a policy checker (always / parse / timeout / command / stage / implementation)")
    ...
    checker_cmd.add_argument("--implementation", default=None, help="retarget the checker implementation label; empty string clears")
