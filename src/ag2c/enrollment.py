...
def _read_json(path: Path) -> dict[str, Any]:
    ...
    return read_json(path, what="AG2C lifecycle file")
...
from .enroll_ops import enroll_project, activate_project, upgrade_project, align_engine, setup_project, repair_project, migrate_project, guard_pre_commit, _externalize_project, recover_relocated_enrollment
