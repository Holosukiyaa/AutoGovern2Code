...
LIQUIDATION_SKILL_NAME = "ag2c-full-liquidation"
PACKAGED_SKILLS = (SKILL_NAME, GOVERNANCE_SKILL_NAME, CENSUS_SKILL_NAME, AUTHORING_SKILL_NAME, LIQUIDATION_SKILL_NAME)
...
6. File-changing work follows ag2c-governed-development. Tree investigation and coverage tags (彻查/普查/打标) follow ag2c-directory-census. Writing 设计思路 from those tags follows ag2c-knowledge-authoring. Named document or interface cards follow ag2c-governance-update. Full liquidation (全量清算) follows ag2c-full-liquidation and runs ONLY when the user explicitly asks for it — never trigger it proactively. Do not git commit on the canonical checkout.
