...
class DesktopServerTests(unittest.TestCase):
    ...
    def test_static_ui_and_status_are_local_desktop_assets(self) -> None:
        ...
        self.assertIn("项目真实目录".encode("utf-8"), body)
        ...
        self.assertIn(b"antv-dagre", graph_script)
        self.assertIn(b"sortByCombo", graph_script)
        self.assertIn(b"collapse-expand", graph_script)
