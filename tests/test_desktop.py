...
class TrayHostSourceTests(unittest.TestCase):
    def test_tray_host_is_hello_imgui_without_webview2_or_pyside(self) -> None:
        ...
        self.assertIn("ag2c-caption-proof.txt", caption)
        self.assertIn("glfwRestoreWindow", caption)
        self.assertIn("glfwMaximizeWindow", caption)
        ...
        self.assertIn("ShowWindow", caption)
